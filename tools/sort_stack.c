...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/16 10:55:15 by ablabib           #+#    #+#             */
/*   Updated: 2025/01/16 10:55:17 by ablabib          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	push_to_a_chunk_range(t_stack **a, t_stack **b, int *i,
...
void	sort_stack(t_stack **a, t_stack **b)
{
	...
	while (*a)
	{
		...
		currect_chunk.end = sorted[min_num((i + 1) + (chunk - 1), size - 1)];
